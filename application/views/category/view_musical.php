  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="col-md-12">
          ...
          <a class="btn btn-warning" href="<?php echo base_url('index') ?>">Kategori Buku</a>
          ...
          <a class="btn btn-success" href="#">Kategori Musical Instrument</a>
          </div>
      </div>
          ...
          <div class="col-md-12">
            ...
            <nav class="navbar navbar-default nav-admin-data" role="navigation">
              <div class="navbar-header">
                <a class="navbar-brand" href="#">Daftar Produk Musical Instrument</a>
              </div>
            </nav> 

              <table id="table_data" class="table table-bordered table-admin">
                <tr>
                  <?php foreach ($view_musical as $o): ?>
