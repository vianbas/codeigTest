          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <i class="fa fa-tags"></i> Kategori Produk<i class="fa fa-caret-down"></i>
              </a>

              <ul class="dropdown-menu tipe-kanan dropdown-menu-login2">
                <li>
                  <a href="<?php echo base_url(); ?>view_produk_books">
                  <i class="fa fa-tags"></i> Buku</a>
                </li>

                <li>
                  <a href="<?php echo base_url(); ?>view_produk_electronics">
                  <i class="fa fa-tags"></i> Electronics</a>
                </li>

                <li>
                  <a href="<?php echo base_url(); ?>view_produk_movie">
                  <i class="fa fa-tags"></i> Movies & TV</a>
                </li>

                <li>
                  <a href="<?php echo base_url(); ?>view_produk_automotive">
                  <i class="fa fa-tags"></i> Automotive</a>
                </li>

                <li>
                  <a href="<?php echo base_url(); ?>view_produk_musical">
                  <i class="fa fa-tags"></i> Musical Instruments</a>
                </li>
              </ul>
            </li>
            ...
            <li>
              <a href="<?php echo base_url();?>petunjuk">
                <i class="fa fa-book"></i> Petunjuk Penggunaan
              </a>
            </li>
